...
2. Для хранения и real-time сообщений использовал firebase;
3. Для скролла добавил невидимый компонент в конце списка, и при изменении массива сообщений скроллю до него;
4. Для изменения username добавил новый action в reducer;
